 ...
 */
contract ClaimsManager is SepoliaConfig, Ownable, ReentrancyGuard {
    // ═══════════════════════════════════════════════════════════════
    // ENUMS & STRUCTS
    // ═══════════════════════════════════════════════════════════════
    ...
    function submitClaim(
        ...
        euint64 claimAmount = FHE.fromExternal(encryptedAmount, amountProof);
     ...
     * @param approvedProof Proof for approved amount
     */
    function approveClaim(
        ...
        euint64 approvedAmount = FHE.fromExternal(encryptedApprovedAmount, approvedProof);
