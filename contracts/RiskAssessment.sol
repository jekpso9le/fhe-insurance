 ...
 */
contract RiskAssessment is ZamaEthereumConfig, Ownable {
    // ═══════════════════════════════════════════════════════════════
    // STRUCTS
    // ═══════════════════════════════════════════════════════════════
     ...
     * @param ageProof Proof for encrypted age
     * @param healthProof Proof for encrypted health score
     * @param creditProof Proof for encrypted credit score
     */
    function createRiskProfile(
        ...
        // Convert encrypted inputs (fhEVM 0.9.1 API)
